...
TEST(MapBasedMatcherTest, LimitSell) {
    MapBasedMatcher matcher{};
    ...
    matcher.process_request(buy1, event_handler);
    matcher.process_request(buy2, event_handler);
    ...
    matcher.process_request(sell1, addtolist);

    ASSERT_EQ(responses.size(), 3);
    EXPECT_TRUE(responses[0].m_event == EventType::TRADE_EXECUTED);
    EXPECT_TRUE(std::get<Trade>(responses[0].m_payload).m_quantity == 50);
    EXPECT_TRUE(std::get<Trade>(responses[0].m_payload).m_price == 60);
    EXPECT_TRUE(responses[1].m_event == EventType::TRADE_EXECUTED);
    EXPECT_TRUE(std::get<Trade>(responses[1].m_payload).m_quantity == 100);
    EXPECT_TRUE(std::get<Trade>(responses[1].m_payload).m_price == 50.50);
    EXPECT_TRUE(std::get<Order>(responses[2].m_payload).m_remaining_quantity == 0);
    ...
    matcher.process_request(buy3, event_handler);
    matcher.process_request(buy4, event_handler);
    ...
    matcher.process_request(sell2, addtolist2);

    ASSERT_EQ(responses2.size(), 1);
    EXPECT_TRUE(responses2[0].m_event == EventType::TRADE_EXECUTED);
    EXPECT_TRUE(std::get<Trade>(responses2[0].m_payload).m_quantity == 10);
    EXPECT_TRUE(std::get<Trade>(responses2[0].m_payload).m_price == 30 );
    EXPECT_TRUE(matcher.get_orderbook().asks.contains(30));
}
